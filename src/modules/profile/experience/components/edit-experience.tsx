...
export const EditExperience = () => {
  ...
  const experienceId = pathname.split("/")[3];
  ...
  useEffect(() => {
    if (editData && editData?.experience) {
      const experience = editData?.experience[0];
      form.reset({
                    ...
                    >
                      <AccordionItem value="experience">
                        ...
                        {hiddenExperienceLength ? (
                          <span>
                            You have {hiddenExperienceLength} hidden
                            experience(s) in your bucket.
                          </span>
                        ) : (
                          ""
                        )}
                        {sortedExperience?.map((exp: any) => (
                          <AccordionContent key={exp.id}>
                            <ActionCard
                              ...
                              deleteDescription={
                                "Are you sure you want to delete this expereince? This action is irreversible and will permanently remove it from your experiences list."
                              }
                              deleteAction={() =>
