...
import {ADD_NEW_SKILL_BY_USER_ID, SKILLS_INFORMATION_BY_USER_ID, UPDATE_SKILL_BY_ID,} from "@/graphql/skills";
                                ...
                                <div className="gap-4 grid grid-cols-1 w-full">
                                    <BubbleInputField
                                        ...
                                        onRemove={(index: number) =>
                                            handleRemoveSkill("technicalSkills", index)
                                        }
                                    ...
                                    <BubbleInputField
                                        ...
                                        onRemove={(index: number) =>
                                            handleRemoveSkill("otherSkills", index)
                                        }
                                        control={form.control}
                                    />
                                    ...
                                    <BubbleInputField
                                        ...
                                        onRemove={(index: number) =>
                                            handleRemoveSkill("languages", index)
                                        }
                                        control={form.control}
                                    />
                                    ...
                                    <BubbleInputField
                                        ...
                                        onRemove={(index: number) =>
                                            handleRemoveSkill("interests", index)
                                        }
                                        control={form.control}
                                    />
                                </div>
